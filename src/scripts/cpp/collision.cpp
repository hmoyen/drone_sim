...
// const char* ssid = "Citi"; //Seu SSID da Rede WIFI
// const char* password = "1cbe991a14"; // A Senha da Rede WIFI
// const char* mqtt_server = "192.168.6.78"; 
const char* ssid = "Striani83_2g"; //Seu SSID da Rede WIFI
const char* password = "striani83"; // A Senha da Rede WIFI
...
void loop() {
  ...
  if (now - lastMsg > REFRESH_RATE) {
    ...
    int stateLED = digitalRead(BUILTIN_LED);
    int state0 = digitalRead(0);
    snprintf (msg, MSG_BUFFER_SIZE, "%ld", stateLED);
